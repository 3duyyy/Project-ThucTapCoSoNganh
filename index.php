...
<body class="home">
    ...
    <!-- banner part starts -->
    <section class="hero bg-image" data-image-src="images/img/food2.png">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1 class="title">Đặt món một cách nhanh chóng </h1>
                ...
                <?php 
                    ...
                    $query_res= mysqli_query($db,"select * from dishes LIMIT 3"); 
                        while($r=mysqli_fetch_array($query_res))
                        {
                            ...
                            echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item h-100%">
        ...
        <div class="container">
            ...
            <div class="row top-footer">
                <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                    <a href="#"> <img src="images/logo.png" alt="Footer logo"
